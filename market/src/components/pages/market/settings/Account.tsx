...
const SettingsNavigation = () => {
	...
	const navigation = [
		{ name: 'Account', href: '/settings/account', icon: UserCircleIcon, current: true },
		{ name: 'Security', href: '/settings/security', icon: KeyIcon, current: false },
...
const Account = (props: { title: string }) => {
										...
										<div tw='grid grid-cols-4 gap-6'>
											<div tw='col-span-4 sm:col-span-3'>
												<label htmlFor='company-website' tw='block text-sm font-medium text-zinc-700'>
													Username
													<span tw='text-xs text-red-500'>*</span>
												</label>
											...
											<div tw='col-span-4 sm:col-span-3'>
												...
												<div tw='mt-1 rounded-md shadow-sm flex'>
													<input
														...
														id='username'
														autoComplete='username'
														tw='focus:ring-sky-500 focus:border-sky-500 flex-grow block w-full min-w-0 rounded-none rounded-md sm:text-sm border-zinc-300'
